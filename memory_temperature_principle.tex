...
\usepackage{xcolor}
\usepackage{booktabs}
\usepackage{array} % Added for column definition (m{...})
\usepackage{hyperref}
...
Full Rust benchmark code and reports: \url{https://github.com/diba7star/Memory_Temperature_Principle/benchmark}
